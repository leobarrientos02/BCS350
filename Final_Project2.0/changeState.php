...
<html lang="en">
        ...
        <header class="masthead">
            <div class="container d-flex h-80 align-items-center">
                <div class="mx-auto text-center">
                    ...
                    <center><h2>Edit State</h2></center>
                    <form action="editState.php" name="contactForm" method="post" onsubmit="return validateForm()" >
                        <div class="card-body">
   ...
   <option>Wyoming</option>
    ...
    <script>
        ...
        var stateErr = verChangeErr = true;
