...
<a style="font-size:25px; position:relative; right:40px; top:40px;" href="product.php">Product</a>
                     ...
                     <table id="employee_data" class="table table-striped table-bordered">  
                          ...
                          {  
                               ...
                               <tr>  
                                    ...
                                    <td>
                                    <img src="uploads/'.$row["picture_name"].'" alt="" border=3 height=200 width=300></img></td>  
