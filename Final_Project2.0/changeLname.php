...
<html lang="en">
        ...
        <header class="masthead">
            <div class="container d-flex h-80 align-items-center">
                <div class="mx-auto text-center">
                    ...
                    <center><h2>Edit Last Name</h2></center>
                    <form action="editName2.php" name="contactForm" method="post" onsubmit="return validateForm()" >
                        <div class="card-body">
                            <img src="assets/images/logo-dark.svg" alt="" class="img-fluid mb-4">
                            
                            <label for="lastName" class="form-label text-white-50">New Last Name</label>
    ...
    <script>
        ...
        var lastNameErr = verChangeErr = true;
