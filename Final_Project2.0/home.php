        ...
        <header class="masthead">
            <div class="container d-flex h-80 align-items-center">
                <div class="mx-auto text-center">
                    ...
                    <img class="rounded-circle" height="100px" width="100px" src="<?php echo htmlspecialchars($pictureURL); ?>" alt='' class='user-avtar' />
                    <?php require_once "getName.php"; ?> 
                    </h2>
                    <a class="btn btn-primary js-scroll-trigger" href="Product.php">Products</a>
                    <a class="btn btn-primary js-scroll-trigger" href="MyAccount.php">My Account</a>
                    <a class="btn btn-primary js-scroll-trigger" href="all_customers.php">All Members</a>
                </div>
            </div>
        </header>
        <!-- About-->
