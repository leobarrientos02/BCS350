...
<html lang="en">
        ...
        <header class="masthead">
            <div class="container d-flex h-80 align-items-center">
                <div class="mx-auto text-center">
                    ...
                    <center><h2>Edit Email Address</h2></center>
                    <form action="editEmail.php" name="contactForm" method="post" onsubmit="return validateForm()" >
                        <div class="card-body">
    ...
    <script>
        ...
        var address1Err = address2Err = cityTownErr = stateErr = zipErr = verChangeErr = true;
    ...
    function validateZip() {
        ...
        function validateForm() {
            ...
            if ((address1Err || || address2Err || cityTownErr || stateErr ||
                zipErr || verChange) == true) {
                return false;
            } else {
                return true;
            }
