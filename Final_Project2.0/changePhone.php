...
<html lang="en">
        ...
        <header class="masthead">
            <div class="container d-flex h-80 align-items-center">
                <div class="mx-auto text-center">
                    ...
                    <form action="editPhone.php" name="contactForm" method="post" onsubmit="return validateForm()" >
                        <div class="card-body">
    ...
    <script>
        ...
        var phoneNumberErr = verChangeErr = true;
    ...
    function validatePhoneNumber() {
        ...
        function validateForm() {
            ...
            if (( phoneNumberErr || verChange) == true) {
                return false;
            } else {
                return true;
            }
