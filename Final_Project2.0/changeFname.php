...
<html lang="en">
        ...
        <header class="masthead">
            <div class="container d-flex h-80 align-items-center">
                <div class="mx-auto text-center">
                    ...
                    <center><h2>Edit First Name</h2></center>
                    <form action="editName.php" name="contactForm" method="post" onsubmit="return validateForm()" >
                        <div class="card-body">
                            <img src="assets/images/logo-dark.svg" alt="" class="img-fluid mb-4">
                            
                            <label for="firstName" class="form-label text-white-50"> New First Name</label>
    ...
    <script>
        ...
        var firstNameErr = verChangeErr = true;
...
if (firstName.value == "") {
    ...
    if (regex.test(firstName.value) === false) {
        ...
        function validateForm() {
            ...
            printError("verChangeErr", "You must certify the change.");
            return false;
        } else {
            ...
            if (( firstNameErr || verChange) == true) {
                return false;
            } else {
                return true;
            }
